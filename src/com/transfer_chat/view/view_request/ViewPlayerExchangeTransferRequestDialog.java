...
public class ViewPlayerExchangeTransferRequestDialog extends ViewTransferRequestDialog {
    ...
    public ViewPlayerExchangeTransferRequestDialog(JFrame owner, String dialogTitle, Transfer transfer) {
        super(owner,dialogTitle, transfer);

        playerExchangeTransfer = sql.getPlayerExchangeTransferGivenTransferID(transfer.getTransferID());
