...
public class MyToast extends JFrame {
    //String of toast
    String s;
    ...
    public MyToast(String s, int x, int y) {
        w = new JWindow();
        ...
        JPanel p = new JPanel() {
            public void paintComponent(Graphics g)
            {
                ...
                g.fillRect(10, 10, wid + 100, hei + 50);
                g.setColor(Color.black);
                g.drawRect(10, 10, wid + 100, hei + 50);

                // set the color of text
                g.setColor(new Color(255, 255, 255, 240));
                g.drawString(s, 50, 47);
                int t = 250;
